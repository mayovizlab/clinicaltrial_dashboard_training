...
#data_import <- read.xlsx("/projects/ccsstat/radonc/admin/shared_code/r/templates/dashboard_rmd_flexdashboard/data/data.xlsx",sheet=1,detectDates=T)
#ae <- read.xlsx("/projects/ccsstat/radonc/admin/shared_code/r/templates/dashboard_rmd_flexdashboard/data/data.xlsx",sheet=2,detectDates=T)
...
#board3 <- pins::board_connect(server = "https://hsr-rsc-prod3.mayo.edu:1919/",
#                             key = Sys.getenv("MOLLY_API_KEY_PROD3"))
# Pull the data list 
#data <- board3 %>% pins::pin_read("M197190/gmror2261_data")
